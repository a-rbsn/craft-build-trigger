...
> {warning} The `buildHookUrl` setting has been replaced by a per-site `buildHookUrls` map. Existing configurations are migrated automatically to the primary site on update.
